...
The [best practices guide](bestpractices.html) discusses versioning issues in depth. It's worth a read.

### Should I create request and response wrappers for all my service methods?

The [best practices guide](bestpractices.html) discusses response and request wrappers.
